...
export default function Contact() {
  const { email, phone, location, socials } = portfolioData.profile;
  ...
  return (
    <main className="section page-section">
      ...
      <div className="contact-grid">
        <ScrollReveal animation="fade-left" delay={100} className="glass-card">
        ...
        <ScrollReveal animation="fade-right" delay={200} className="glass-card">
          <form action={`https://formsubmit.co/${email}`} method="POST" className="contact-form">
